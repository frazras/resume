...
\header{Rohan }{Smith}{Software Architect | AI Engineer | Innovative Entrepreneur | \includegraphics[height=16pt]{druplicon.png} Drupal Developer}% | DevOps Engineer | embedded hardware electronics developer} % Your name and current job title/field
...
%https://www.youtube.com/@AISmithOfficial
...
\begin{itemize}
    \item 10X is easier than 2X, Infinite Game, Hyperfocus, The Passion Paradox, 80/20 Running
