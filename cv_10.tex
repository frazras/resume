...
\header{rohan}{smith}{software architect | web application developer | embedded hardware electronics developer} % Your name and current job title/field
...
\begin{itemize}
    \item Managed 6 member remote team of developers and designers.
